...
@Model(
        ...
        adapters = { UserListModel.class, ComponentExporter.class },
        resourceType = UserListModelImpl.RESOURCE_TYPE,
...
public class UserListModelImpl implements UserListModel {
    ...
    static final String RESOURCE_TYPE = "amr-test-37/components/user-list";
    ...
    public String getExportedType() {
        return UserListModelImpl.RESOURCE_TYPE;
    }
}
